module.exports = function Substeps(){
  ...
  var substepsParser = require('./parser/substeps/substepsParserFactory')(executionFactory, output);
  var featureParser = require('./parser/feature/featureParserFactory')(executionFactory, output, _);
