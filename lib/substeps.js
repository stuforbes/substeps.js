module.exports = function Substeps(){
  ...
  var stepLoader = require('./step/stepLoader')(require('asyncjs'), require('fs'), require('vm'));
  var substepsParser = require('./parser/substeps/substepsParserFactory')(executionFactory, definitionRegistry, outpupusht);
  ...
  return {
    start: function(){
      ...
      wait.launchFiber(function(){
        ...
        var steps = wait.for(stepLoader.loadStepImplementations, stepFiles);
        ...
        var substepsDefinitions = wait.for(substepsParser.parse, substeps, steps);
