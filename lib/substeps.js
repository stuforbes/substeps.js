module.exports = function Substeps(){
  ...
  var executionFactory = require('./execution/executionFactory')(stepRegistry, callbackIterator, require('./execution/parameterExtractor'), require('./execution/stepParameterLocator')(_), output, _);
