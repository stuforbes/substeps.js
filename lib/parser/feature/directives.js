  ...
  return {
    ...
    directiveScenario: function(){
      return {
        ...
        isApplicable: function(previous){ return previous.type === 'feature'},
        create: function(text){
          return {type: 'scenario', node: {prefix: 'Scenario:', text: text, outline: false, steps: []}}
        },
        bindTo: function(node, parent){
    ...
    directiveScenarioOutline: function(){
      return {
        ...
        isApplicable: function(previous){ return previous.type === 'feature'},
        create: function(text){
          return {type: 'scenario-outline', node: {prefix: 'Scenario Outline', text: text, outline: true, steps: []}}
        },
        bindTo: function(node, parent){
          if(parent.scenarios === undefined){
            parent.scenarios = [];
